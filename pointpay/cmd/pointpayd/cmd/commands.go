...
import (
	...
	"github.com/pointpay/pointpay/app"
)
...
// genesisCommand builds genesis-related `pointpayd genesis` command. Users may provide application specific commands as a parameter
